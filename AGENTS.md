...
This project is indexed by GitNexus as **open-ralph-wiggum** (2593 symbols, 3577 relationships, 42 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
