...
This project is indexed by GitNexus as **open-ralph-wiggum** (2290 symbols, 3131 relationships, 40 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
